...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorMssageTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMssageTextView = (TextView) findViewById(R.id.error_msg);
    ...
    private void loadWeatherData() {
        // (20) Call showWeatherData before executing the AsyncTask
        showWeatherDataView();
    ...
    private void showWeatherDataView() {
        mErrorMssageTextView.setVisibility(View.INVISIBLE);
    ...
    private void showErrorMessage() {
        ...
        mErrorMssageTextView.setVisibility(View.VISIBLE);
    }
