...
//  Done (12) Create a method to schedule our periodic weather sync
    static void scheduleFirebaseJobScheduler(@NonNull final Context context) {
        ...
        Job myJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(SYNC_INTERVAL_SECONDS, SYNC_INTERVAL_SECONDS+SYNC_INTERVAL_SECONDS/3))
...
//      Done (13) Call the method you created to schedule a periodic weather sync
        scheduleFirebaseJobScheduler(context);
