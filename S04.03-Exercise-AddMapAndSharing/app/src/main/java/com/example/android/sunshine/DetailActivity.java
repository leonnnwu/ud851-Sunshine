...
public class DetailActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem actionShareItem = menu.findItem(R.id.action_share);
        actionShareItem.setIntent(createShareForecastIntent());
        return true;
    }
    ...
    private Intent createShareForecastIntent() {
        return ShareCompat.IntentBuilder.from(this)
                .setType("text/plain")
                .setText(mWeatherDisplay.getText() + FORECAST_SHARE_HASHTAG)
                .getIntent();
    }
