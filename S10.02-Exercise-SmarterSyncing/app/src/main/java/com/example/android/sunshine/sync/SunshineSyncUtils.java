    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                Uri weatherDataUri = WeatherContract.BASE_CONTENT_URI;
                String[] projectionColumns = {WeatherContract.WeatherEntry._ID};
                String selectionStatement = WeatherContract.WeatherEntry.getSqlSelectForTodayOnwards();
                Cursor cursor = context.getContentResolver().query(weatherDataUri, projectionColumns, selectionStatement, null, null);
