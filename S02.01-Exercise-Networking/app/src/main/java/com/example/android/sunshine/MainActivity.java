...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String currentLocation = SunshinePreferences.getPreferredWeatherLocation(this);
    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... locations) {
            ...
            if(locations.length != 0) {
                ...
                try {
                    URL queryURL = NetworkUtils.buildUrl(locations[0]);
                    String jsonResult = NetworkUtils.getResponseFromHttpUrl(queryURL);
                    simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonResult);
                } catch (IOException e) {
                    e.printStackTrace();
